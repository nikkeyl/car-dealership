import { removeClasses } from '@js/base/removeClasses.js';
import { dataMediaQueries } from '@js/base/dataMedia.js';
import { _slideDown } from '@js/base/slideDown.js';
import { _slideUp } from '@js/base/slideUp.js';
import { getHash } from '@js/base/getHash.js';
import { setHash } from '@js/base/setHash.js';
    ...
    function setTabsAction(e) {
        ...
        if (el.closest('[data-tabs-title]')) {
            ...
            if (!tabTitle.classList.contains('tab-active') && !tabsBlock.querySelector('.slide')) {
                ...
                removeClasses(tabActiveTitle, 'tab-active');
